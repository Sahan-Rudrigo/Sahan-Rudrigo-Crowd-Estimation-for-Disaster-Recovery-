...
#     # ==========================================
#     FRAME_SKIP = 5  # Process every 2nd frame to prevent lag. (Change to 3 if still lagging)
...
# At the very top of run_multi_camera_system(), after the prints:
import os
import cv2
import time
from ultralytics import YOLO

from disaster_recovery.dashboard.state_writer import StateWriter

# --- Custom Modules ---
from disaster_recovery.core.reid_model import ReIDExtractor
from disaster_recovery.tools.homography import HomographyMapper
from disaster_recovery.core.matcher import GlobalTracker
